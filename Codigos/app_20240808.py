...
path_resultados = r"C:\Projetos\2022_23_LIGHT_Sust_Concessao\Fase 1\3 - Resultados\Delos\19-06-2024\Concat\\"
...
shp_AR = gpd.read_file(r'C:\Git\2023_Light_Dash\LS\Dados\AR - Areas de Risco\ASRO\ASRO.shp')
    ...
    with tab3:
        ...
        with st.spinner("Carregando mapa..."):
            ...
            <ul class='legend-labels' style="list-style-type: none; padding: 0; margin: 0;">
                <li><a style='color: gray; margin-left: 2px;'>&FilledSmallSquare; </a> N </li>
                <li><a style='color: red; margin-left: 2px;'>&FilledSmallSquare; </a> D </li>
                <li><a style='color: blue; margin-left: 2px;'>&FilledSmallSquare; </a> U </li>
                <li><a style='color: green; margin-left: 2px;'>&FilledSmallSquare; </a> I </li>
